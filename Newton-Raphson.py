...
def newton_raphson(f, grad_f, hess_f, x0, eps1, eps2, max_iter):
    x = x0
    iter_count = 0
...
# Тестирование метода Ньютона-Рафсона на функции f(x,y)
x0 = np.array([1.5, 0.1])
eps1 = 1e-6
eps2 = 1e-6
max_iter = 1000

x_min, iter_count, grad_norm = newton_raphson(f, grad_f, hess_f, x0, eps1, eps2, max_iter)
